    ...
    public abstract class ElementBuilder
    {
        ...
        private void FillProperties(object target, Dictionary<string, object> propertyDescriptions)
        {
            if (propertyDescriptions != null)
            {
                ...
                {
                    var property = target.GetType().GetProperty(kvp.Key);
                    FillProperty(target, property, kvp.Value);
                }
            }
        }

        private void FillProperty(object target, PropertyInfo property, object value)
        {
            ...
            if (stringValue != null)
            {
                ...
                {
                    FillCustomProperty(target, property, stringValue);  
                    return;
                }
            }
        ...
        private void FillCustomProperty(object target, PropertyInfo property, string keyAndConfiguration)
        {
            string key;
            ...
            setter.Set(target, property, configuration);
        }
